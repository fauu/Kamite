...
public final class UnixMPVController implements MPVController {
  ...
  private MPVController.State state;
  private SocketChannel unixSocketChannel;

  public UnixMPVController(Platform platform, Consumer<PlayerStatus> statusUpdateCb) {
